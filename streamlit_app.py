...
def build_pdf(chart: dict) -> bytes:
    ...
    # ── bhava chalit chart + transit chart ──────────────────────────────────────
    ...
    story.append(Paragraph("Bhava Chalit: houses centred on the Ascendant degree, so a planet "
                           "near a sign edge can fall into the adjacent bhava. "
                           "Transits: current sky vs natal Lagna.", cap))
