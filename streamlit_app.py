...
with tabs[8]:
    ...
    if yogas is None:
        ...
        st.caption("Common Parashari yogas read from the natal D1 (whole-sign houses, graha "
                   "drishti). Includes the five Mahapurusha, Raja, Dhana, Vipareeta Raja, and "
                   "Sun/Moon yogas (Veshi/Vasi, Sunapha/Anapha/Durudhara, Kemadruma, Gajakesari…). "
        ...
        st.caption("Mahapurusha = Mars/Mercury/Jupiter/Venus/Saturn exalted or in own sign in a "
                   "kendra. Raja = kendra-lord ↔ trikona-lord link. Dhana = links among the "
                   "2/5/9/11 lords. Kemadruma = the Moon left unsupported by neighbours.")
